  ...
  return (
    <div className="grid place-items-center h-full px-10 pt-28 lg:pt-0 lg:px-0">
      {product ? (
        <div className="lg:flex">
          <div className="lg:w-1/2 mb-6 lg:mb-0">
            <div className="w-full relative">
              <button className="absolute left-0 bottom-0 p-1 sm:p-2 bg-amber-500">
                <FavoriteBorderRounded className="text-red-800 scale-75 sm:scale-100" />
              </button>
              <img
                className="w-full"
                src={product?.media.imageUrl ? product?.media.imageUrl : alt}
                alt=""
              />
            </div>
          </div>
          ...
          <div className="lg:ml-10 lg:pr-28 lg:w-1/2 pb-10 lg:pb-0 ">
            <div className="border-b border-gray-200 pb-4">
              ...
              <div className="flex justify-between w-5/6 mb-3">
                <p className="text-green-700 uppercase text-sm sm:text-base">
                  {product?.brand}
                </p>
            ...
            <div className="flex items-center border-b border-gray-200 py-4">
              <div className="flex items-center">
                ...
                <FormControl
                  sx={{ m: 1, minWidth: 80 }}
                  className="ml-2 sm:ml-4 sm:scale-100 scale-75"
                  size="small"
                >
                  <Select
              ...
              <div className="flex items-center ml-3 sm:ml-5">
                ...
                >
                  <Select
                    ...
                    autoWidth
                  >
                    {Array.from({ length: 10 }, (_, i) => i + 1).map((siz) => (
                      <MenuItem value={siz}>{siz}</MenuItem>
                    ))}
                  </Select>
                </FormControl>
            ...
            <div className="flex justify-between items-center pt-4">
              <p className="font-semibold text-xl">
                ₦ {product?.retailPrice * qty}.00
              </p>
              <button
                className={`${
                  btnText === "add to cart" ? "bg-green-600" : "bg-green-700"
                } text-white px-10 py-2 text-sm sm:text-base sm:py-3 uppercase`}
        ...
        <TailSpin color="rgb(21 128 61)" height={80} width={80} />
      )}
    </div>
  );
};
