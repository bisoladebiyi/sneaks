    ...
    return (
        <div className="w-full h-full relative">
            <div className="flex h-full header relative -ml-72">
                <img className="h-full w-3/4 xl:w-auto"  src={img2} alt="" />
                <img className="h-full" src={img3} alt="" />
            </div>
            <div className="absolute top-1/3 left-0 sm:left-10 md:left-32 shop w-full sm:w-1/2 md:w-2/5 lg:w-4/12 p-4 sm:p-8 bg-background header-text">
                <p className="text-xl sm:text-2xl text-gray-700 uppercase font-bold leading-8 mt-3">High-Quality Sneakers Just For You</p>
